    ...
    return (
        <form onSubmit={handleSubmit} className="relative w-full">
            <input
                ...
                className="w-full px-6 py-4 pr-16 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 shadow-sm outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all disabled:opacity-50 text-[15px]"
            />
            <button
                type="submit"
