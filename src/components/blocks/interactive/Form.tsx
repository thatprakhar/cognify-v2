...
export const Form: React.FC<FormProps> = ({ fields = [], submitLabel }) => {
 ...
 return (
 <form onSubmit={handleSubmit} className="space-y-5 p-6 border border-zinc-200 rounded-2xl bg-white ">
 ...
 className="p-3 border border-zinc-300 rounded-lg bg-transparent text-zinc-900 outline-none focus:ring-2 focus:ring-blue-500"
 >
