...
export type GoalType = 'understand' | 'decide' | 'analyze' | 'create' | 'compare' | 'learn'
export type IntentType = 'explanation' | 'analysis' | 'decision' | 'creation' | 'comparison' | 'learning'
...
export type PipelineStage = 'intent' | 'ux' | 'rendering'
